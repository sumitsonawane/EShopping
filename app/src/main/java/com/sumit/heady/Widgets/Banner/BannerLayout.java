package com.sumit.heady.Widgets.Banner;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setColor(getResources().getColor(R.color.dotActive));
            selectedGradientDrawable.setSize(dp2px(7), dp2px(7));
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setColor(getResources().getColor(R.color.dotInActive));
...
//        linearSnapHelper.attachToRecyclerView(mRecyclerView);
    ...
    public void setAdapter(RecyclerView.Adapter adapter, Integer size) {
        hasInit = false;
